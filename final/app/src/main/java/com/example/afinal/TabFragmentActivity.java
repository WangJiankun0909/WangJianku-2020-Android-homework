...
import com.example.afinal.fragment.TabFirstFragment;
import com.example.afinal.fragment.TabSecondFragment;
import com.example.afinal.fragment.TabThirdFragment;
...
public class TabFragmentActivity extends AppCompatActivity {
    ...
    private String[] hintArray = {"p30", "p40", "Mate40", "pad", "iphone7 plus"};
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) { // 点击了工具栏左边的返回箭头
            ...
            return true;
        } else if (id == R.id.menu_sign) { // 点击了登录菜单项
            // 跳转到登录页面
            Intent intent = new Intent(this, MainActivity.class);
            startActivity(intent);
        } else if (id == R.id.menu_register) { // 点击了注册菜单项
            // 跳转到注册页面
